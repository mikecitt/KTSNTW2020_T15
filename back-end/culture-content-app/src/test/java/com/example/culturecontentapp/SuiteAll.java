...
@RunWith(Suite.class)
@Suite.SuiteClasses({ SuiteSubTypeTests.class, NewsServiceIntegrationTest.class, UserRepositoryIntegrationTest.class,
            NewsRepositoryIntegrationTest.class, NewsControllerIntegrationTest.class, SuiteVerificationTokenTests.class,
            SuiteReviewTests.class, SuiteSubscriptionTests.class, SuiteAuthenticationTests.class,
            SuiteAccountTests.class })
